                ...
                <div className="space-y-4">
                  <div className="bg-white p-5 rounded-lg shadow-sm">
                    ...
                    <ul className="list-disc list-inside mt-2 text-gray-700">
                      <li>
                        Enhanced interpersonal skills through stakeholder &
                        customer engagement
                      </li>
                      <li>
                        Developed problem-solving and escalation practices
                      </li>
                      <li>
                        Gained experience with enterprise software frameworks &
                        e-commerce tools
                      </li>
                    </ul>
                  </div>
            ...
            <FadeInSection delay={900}>
              <section className="mb-12">
                ...
                <div className="bg-white p-5 rounded-lg shadow-sm">
                  ...
                  <ul className="list-disc list-inside mt-2 text-gray-700">
                    <li>
                      Front-end application architecture & scalable UI design
                    </li>
            ...
            <FadeInSection delay={1200}>
              <section>
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="bg-white p-3 shadow-sm rounded-lg">
                    Lifeline (July 2023, 2024, 2025)
                  </li>
                  <li className="bg-white p-3 shadow-sm rounded-lg">
                    Mona Vale Art Show
                  </li>
                  <li className="bg-white p-3 shadow-sm rounded-lg">
                    Lifeline Knox Book Fair
                  </li>
                </ul>
              </section>
            </FadeInSection>
